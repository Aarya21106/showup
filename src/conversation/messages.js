...
const T = {
  en: {
    ...
    dailyPrompt: (activity) => `Time to show up — what's the move today for ${activity}? Send me a quick line + a photo when it's done. I know you've got this.`,
    needPhoto: () => 'Love the update — now send me a photo too so I can check it in properly.',
    ...
    finalPartial: (days, payout) =>
      `${config.pledgeDays} days done, ${days} of them counted. ₹${payout} coming back to you. However it went — you showed up more than you would've without this, and that's not nothing.`,
  ...
  ta: {
    ...
    dailyPrompt: (activity) => `நேரமாச்சு — இன்று ${activity}-க்காக என்ன செய்கிறீர்கள்? முடிந்ததும் ஒரு வரியும் ஒரு புகைப்படமும் அனுப்புங்கள். உங்களால் முடியும்.`,
    needPhoto: () => 'அப்டேட் பிடிச்சிருக்கு — இப்போது ஒரு புகைப்படத்தையும் அனுப்புங்கள், சரியாக சரிபார்க்கிறேன்.',
    checkinAccepted: (streak, daysLeft) =>
  ...
  hi: {
    ...
    dailyPrompt: (activity) => `समय हो गया — आज ${activity} के लिए क्या कर रहे हैं? हो जाए तो एक लाइन + एक फोटो भेजें। आप कर सकते हैं।`,
    needPhoto: () => 'अपडेट अच्छा लगा — अब एक फोटो भी भेजिए ताकि मैं ठीक से चेक-इन कन्फर्म कर सकूं।',
    checkinAccepted: (streak, daysLeft) =>
